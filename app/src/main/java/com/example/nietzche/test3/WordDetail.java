...
public class WordDetail {
    public String word;
    public int wid;//一个word仅一个wid
    public int[] mids;//一个word多个meaning，多个mid
    // 一个meaning只取一个例句
    public String[] type;
    public String[] MeaningsEN;
    public String[] MeaningsCN;
    public String[] ExamplesEN;
    public String[] ExamplesCN;

    public WordDetail() {
    }

    static class HtmlFont {
    ...
    public boolean find(SQLiteDatabase database, String word) {
        this.word = word;

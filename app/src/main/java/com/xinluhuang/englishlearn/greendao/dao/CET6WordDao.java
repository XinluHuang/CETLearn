...
*/
public class CET6WordDao extends AbstractDao<CET6Word, Integer> {

    public static final String TABLENAME = "tbWord";

    /**
     * Properties of entity CET6Word.<br/>
    ...
    public CET6WordDao(DaoConfig config) {
        super(config);
    }
    
    public CET6WordDao(DaoConfig config, DaoSession daoSession) {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, CET6Word entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, CET6Word entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getId());
    ...
    @Override
    public CET6Word readEntity(Cursor cursor, int offset) {
        CET6Word entity = new CET6Word( //
    ...
    @Override
    public void readEntity(Cursor cursor, CET6Word entity, int offset) {
    ...
    @Override
    protected final Integer updateKeyAfterInsert(CET6Word entity, long rowId) {
        return entity.getId();
    }
    
    @Override
    public Integer getKey(CET6Word entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(CET6Word entity) {
